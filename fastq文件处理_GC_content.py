...
def GC_content():  # GC含量统计,并将统计结果写入csv文件
    ...
    for key, value in seq.items():
        ...
        data.append((key,value,len(value),gc_content))
    with open(r"D:\My Projects\01_test\tem.csv", "w+", newline="") as csv_file:  # 可考虑定义函数直接调用，减少代码的使用
        csv_header = ["seq_id", "seq", "len", "GC_content"]
...
def read_exclude():  # 根据reads id提取read（从fastq文件或者fasta文件中提取reads）
    pass
...
if __name__ == "__main__":
    ...
    # fa_output_file_path = sys.argv[3]
